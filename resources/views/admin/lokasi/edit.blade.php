...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <!-- form validasi -->
            <form class="forms-sample" action="{{ url('/lokasi/update', $lokasi->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="nama_lokasi" name="nama_lokasi"
                            placeholder="Nama Lokasi" value="{{ $lokasi->nama_lokasi }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="alamat" name="alamat"
                            placeholder="Alamat" value="{{ $lokasi->alamat}}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="jenis_olahraga" name="jenis_olahraga"
                            placeholder="Jenis Olahraga" value="{{ $lokasi->jenis_olahraga }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" id="tanggal" name="tanggal"
                            placeholder="Tanggal" value="{{ $lokasi->tanggal }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="time" class="form-control" id="waktu" name="waktu"
                            placeholder="Waktu" value="{{ $lokasi->waktu }}">
                    </div>
                </div>
